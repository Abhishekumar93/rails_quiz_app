...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { Answer: @answer.Answer, Question_Q_No: @answer.Question_Q_No } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { Answer: @answer.Answer, Question_Q_No: @answer.Question_Q_No } }
